...
def startJob(runtime):
	...
	try:
		...
		if client is not None:
			...
			## Do the work
			resultDictionary = getSoftwarePackages(runtime, client, nodeId, trackResults=True)
			...
			runtime.logger.report('results of shell_OS_software_packages: {results!r}', results=runtime.results.getJson())
