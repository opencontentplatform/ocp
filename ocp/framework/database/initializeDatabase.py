...
def createQueryDefinitions(dbClient, logger):
	...
	try:
		...
		query2 = {"objects": [{"label": "NODE1","class_name": "Node","attributes": ["caption","vendor","platform","version","hardware_provider"],"minimum": "1","maximum": "","linchpin": True},{"label": "PROCESS1","class_name": "ProcessFingerprint","attributes": ["caption", "process_owner", "process_args", "path_from_process", "path_from_analysis", "path_working_dir", "process_hierarchy"],"minimum": "1","maximum": ""}, {"label": "PORT1","class_name": "TcpIpPort","attributes": ["caption", "ip", "port_type"],"minimum": "1","maximum": ""}, {"label": "PROCESS2","class_name": "ProcessFingerprint","attributes": ["caption", "process_owner", "process_args", "path_from_process", "path_from_analysis", "path_working_dir", "process_hierarchy"],"minimum": "1","maximum": ""}, {"label": "NODE2","class_name": "Node","attributes": ["caption","vendor","platform","version","hardware_provider"],"minimum": "1","maximum": ""}, {"label": "SOFTWARE1","class_name": "SoftwareFingerprint","attributes": ["caption", "software_info", "software_version", "vendor"],"minimum": "0","maximum": ""}, {"label": "SOFTWARE2","class_name": "SoftwareFingerprint","attributes": ["caption", "software_info", "software_version", "vendor"],"minimum": "0","maximum": ""}],"links": [{"label": "NODE_TO_SOFTWARE","class_name": "Enclosed","first_id": "NODE1","second_id": "PROCESS1"},{"label": "PROCESS1_TO_PORT1","class_name": "WeakLink","first_id": "PROCESS1","second_id": "PORT1"}, {"label": "PORT2_TO_PROCESS1","class_name": "WeakLink","first_id": "PORT1","second_id": "PROCESS2"}, {"label": "NODE2_TO_PROCESS2","class_name": "Enclosed","first_id": "NODE2","second_id": "PROCESS2"}, {"label": "SOFTWARE1_TO_PROCESS1","class_name": "Usage","first_id": "SOFTWARE1","second_id": "PROCESS1"}, {"label": "SOFTWARE2_TO_PROCESS2","class_name": "Usage","first_id": "SOFTWARE2","second_id": "PROCESS2"}]}
