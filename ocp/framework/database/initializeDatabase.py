...
def createQueryDefinitions(dbClient, logger):
	...
	"""
	try:
		query1 = {"objects": [{"label": "NODE","class_name": "Node","attributes": [ "caption", "domain" ],"minimum": "1","maximum": "","filter": [{"condition": {"attribute": "reference_id","operator": "isnull","value": None}}],"linchpin": True},{"label": "IP","class_name": "IpAddress","attributes": [ "caption" ],"minimum": "0","maximum": "","filter": [{"condition": {"attribute": "address","operator": "!=","value": "127.0.0.1"}}]},{"label": "HW","class_name": "HardwareNode","attributes": ["caption", "vendor", "model", "serial_number", "bios_info"],"minimum": "0","maximum": ""},{"label": "SHELL","class_name": "Shell","attributes": ["caption", "ipaddress", "protocol_reference", "realm", "config_group"],"minimum": "0","maximum": "","filter": []},{"label": "WMI","class_name": "WMI","attributes": ["caption", "ipaddress", "protocol_reference", "realm"],"minimum": "0","maximum": "","filter": []},{"label": "SNMP","class_name": "SNMP","attributes": ["caption", "ipaddress", "protocol_reference", "realm"],"minimum": "0","maximum": "","filter": []},{"label": "REST","class_name": "REST","attributes": ["caption", "ipaddress", "protocol_reference", "base_url", "realm"],"minimum": "0","maximum": "","filter": []}], "links": [{"label": "NODE_TO_IP","class_name": "Usage","attributes": [],"first_id": "NODE","second_id": "IP"},{"label": "NODE_TO_HW","class_name": "Usage","attributes": [],"first_id": "NODE","second_id": "HW"},{"label": "NODE_TO_SHELL","class_name": "Enclosed","attributes": [],"first_id": "NODE","second_id": "SHELL"},{"label": "NODE_TO_WMI","class_name": "Enclosed","attributes": [],"first_id": "NODE","second_id": "WMI"},{"label": "NODE_TO_SNMP","class_name": "Enclosed","attributes": [],"first_id": "NODE","second_id": "SNMP"},{"label": "NODE_TO_REST", "class_name": "Enclosed", "attributes": [], "first_id": "NODE", "second_id": "REST"}]}
