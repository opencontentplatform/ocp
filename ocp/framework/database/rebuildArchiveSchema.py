"""Utility to drop and recreate the 'archive' schema and tables.
...
def createSchema(dbClient, logger):
	...
	try:
		...
		print('Dropping archive schema...')
		logger.debug('Dropping archive schema...')
		dbClient.engine.execute('drop schema if exists archive cascade')
		dbClient.engine.execute('create schema archive')
